...
class AddressSearch extends Address {
    ...
    public function rules() : array {
        ...
        return [
            [['ulica_prefix', 't_ulica', 'ulica', 'dom', 'dom_szczegol', 'lokal', 'lokal_szczegol', 'pietro'], 'safe'],
        ];
    }

    public function search($params) {
        
        $query = Address::find()->select(['id', 't_ulica', 'ulica_prefix', 'ulica', 'dom', 'dom_szczegol', 'lokal', 'lokal_szczegol', 'pietro']);
