...
class m171216_174700_create_table extends Migration
{
    public function up(){
        ...
        $this->createTable('{{address}}', [
            'id' => Schema::TYPE_UBIGPK . "DEFAULT nextval('address_id_seq'::regclass)",
        ...
        $this->createTable('{{teryt}}', [
            ...
            't_miasto' => $this->char(7)->notNull(),
            't_ulica' => $this->char(7)->notNull(),
            'ulica_prefix' => $this->string(5)->notNull(),
        ...
        $this->createTable('{{device}}', [
            ...
            'address_id' => $this->bigInteger()->unsigned(),
            'type_id' => $this->integer()->notNull(),
            'alias' => $this->string(50),
            'proper_name' => $this->string(30),
            'dhcp' => $this->boolean(),
            'smtp' => $this->boolean(),
            'monitoring' => $this->boolean(),
            'geolocation' => $this->string(),
            'input_level' => $this->float(1),
            'input_power' => $this->float(1),
            'output_power' => $this->float(1),
            'host_type' => $this->smallInteger(),
        ]);
